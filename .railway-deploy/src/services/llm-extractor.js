...
13. Если явного артикульного кода нет, но позиция явно упомянута (оборудование, материал, расходник) — используй code = "DESC:" + краткий транслит описания латиницей через дефис, до 40 символов. Пример: "DESC:sharovoy-kran-DN50-PN16". Это лучше чем пропускать позицию. Правило 1 (code никогда не null) остаётся: DESC: — допустимый code.`;
