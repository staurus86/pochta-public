...
export function normalizeIntegrationMessage(project, message, options = {}) {
  ...
  return {
    ...
    lead: {
      ...
      product_name_primary: lead.productNamePrimary || null,
      product_names_clean: lead.productNamesClean || [],
      primary_quantity: lead.primaryQuantity ?? null,
      quantity_unit: lead.quantityUnit || null,
      total_quantity: lead.totalQuantity ?? null,
      quantities_clean: lead.quantitiesClean || [],
